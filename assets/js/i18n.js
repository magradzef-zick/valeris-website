...
window.VALERIS_I18N = {
  en: {
    ...
    'hero.sub': "We connect Europe and India through local presence, practical support and deep knowledge of both markets. We operate on the ground in Maharashtra — verifying suppliers, representing our clients, and helping companies expand without building their own structure in India.",
    ...
    'directions.card1Desc': "We act as your local partner in Maharashtra. We verify suppliers, represent your company, and support you at every stage of growing your business in India. With local presence, you make decisions based on real information — not partner claims alone.",
    ...
    'directions.card2Desc': "We help Indian companies build a presence in the European market. We combine local knowledge of Poland and Europe with experience gained in India, making market entry simpler and more predictable.",
    ...
    'services.intro': 'Every engagement starts where you are — whether that is initial market curiosity or preparation for full operational presence. We work as a local partner, not a distant advisor.',

    'svc.1.title': 'Supplier Verification',
    'svc.1.desc': "Before you commit to a supplier in India, know exactly who you're dealing with. We go there in person — to the factory, face to face — and deliver a clear, independent assessment before you sign a contract or send a first payment.",
    'svc.1.d1': 'Reputation, market standing and company history checks',
    'svc.1.d2': 'Corporate registration verification — confirming the business is legitimate and operational',
    'svc.1.d3': 'On-the-ground business intelligence',
    'svc.1.d4': 'Direct engagement with the manufacturer',
    'svc.1.d5': 'An on-site factory visit confirming production capacity is real',
    'svc.1.d6': 'A structured assessment covering production scale, organisation and basic standards',
    'svc.1.d7': 'A written visit report with findings and our assessment',

    'svc.2.title': 'Poland Market Entry for Indian Companies',
    'svc.2.desc': "We help Indian companies enter the Polish market — understanding how it works, building a local presence, and starting to sell. With teams on the ground in both Maharashtra and Poland, we understand both markets from the inside.",
    ...
    'svc.3.desc': "India is a large, complex market. We help Polish companies understand how business is really done there and build a well-informed, practical strategy for entering it.",
    ...
    'svc.3.d4': 'Introductions to vetted business partners in Maharashtra',
    'svc.3.d5': 'Access to vetted local lawyers, tax advisors and accountants',
    'svc.3.synergy': "Legal and accounting services are handled by specialist partners we know personally — we make the introductions and guide you through the process.",

    'svc.4.title': 'Representation in India',
    'svc.4.desc': "Not every company needs to set up a legal entity in India right away. We represent your business on the ground, take part in meetings, build relationships, and support your growth — without you needing to build your own team in India.",
    'svc.4.d1': 'In-person representation at trade fairs, industry conferences and business meetings',
    'svc.4.d2': 'Prospecting and meeting potential partners on your behalf',
    'svc.4.d3': 'Ongoing market intelligence and sector monitoring',
    'svc.4.d4': 'Relationship development with manufacturers, distributors and key suppliers',
    'svc.4.d5': 'End-to-end planning for your business visits to India',
    'svc.4.synergy': 'A permanent presence in Maharashtra — without the overhead of a local entity.',

    'svc.5.title': 'Operational Support',
    'svc.5.desc': "Once a project is underway, we support it on the ground. We organise meetings, resolve day-to-day problems, and coordinate with local partners — so you don't have to be in India for every decision.",
    'svc.5.d1': 'Identifying and connecting you with the right partners and suppliers',
    'svc.5.d2': 'Communication and negotiation support with local counterparts',
    'svc.5.d3': 'Sourcing production facilities and warehouse space',
    'svc.5.d4': 'Local team setup and recruitment support',
    'svc.5.d5': 'Organising site visits and partner meetings',
    'svc.5.d6': 'Resolving operational problems as they arise',
    ...
    'process.1t': 'Initial consultation', 'process.1d': "We get to know your project and identify exactly what you need — sometimes that's verifying a single supplier, sometimes it's long-term support in the Indian market.",
    'process.2t': 'Scope & proposal', 'process.2d': "We define the scope of work, timeline and how we'll collaborate. You know exactly what we're doing, when, and why.",
    'process.3t': 'On-the-ground work', 'process.3d': "We visit the factory, meet with partners, hold conversations and verify information directly in India. This is the stage that sets Valeris apart from conventional advisory.",
    'process.4t': 'Report & next steps', 'process.4d': "You receive concrete information, recommendations and next steps. You make decisions based on market facts — not guesswork.",
    ...
    'essence.desc': "That's why we're present on both sides of the market — combining knowledge, local presence and practical experience to make doing business between Europe and India less complex.",

    'partner.kicker': 'Strategic partnership',
    'partner.title': 'Working with Polfrost — logistics you can rely on',
    'partner.desc': "Experience stands behind Valeris. We've grown in partnership with Polfrost — a company with over 30 years in international logistics. This lets us combine our local presence in India with expertise built delivering import projects for companies across industries. For our clients, that partnership means access to both market knowledge and a proven operational base.",
    ...
    'form.errorConfig': 'The form is not connected yet. Please email us directly.',
    'form.sending': 'Sending…',

    'footer.desc': 'Your trusted partner for Poland–India trade development. On the ground, on both sides.',
    ...
    'pharma.1.desc': "Before committing to a demanding certification process, it is worth establishing whether European market entry makes commercial sense for your specific business.",
    ...
    'pharma.2.desc': "Certification is one of the steepest barriers for Indian pharmaceutical companies entering Europe. We do not certify — but we help you build a credible path to certification.",
    ...
    'pharma.3.title': 'Partner Search in Europe', 'pharma.3.sub': 'Identifying and engaging business partners',
    ...
    'pharma.4.title': 'European Representation', 'pharma.4.sub': 'Your presence on the ground in Europe',

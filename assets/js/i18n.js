...
window.VALERIS_I18N = {
  en: {
    ...
    'directions.card2Desc': "We help Indian companies navigate the Polish market, establish their presence, and begin selling. With operations in both Maharashtra and Poland, we understand both sides.",
    ...
    'svc.1.desc': "Before you commit to a supplier in India, know who you are dealing with. We go there in person — to the factory, face to face — and deliver a clear assessment before you sign a contract or make a first payment.",
    ...
    'svc.4.desc': "Establishing a legal entity in India is not always the right first step. A local partner representing you on the ground in Maharashtra gives you real presence — without the cost or complexity of building your own structure.",
    ...
    'svc.5.desc': "Operating a project in India means navigating real, day-to-day challenges on the ground. We are the local partner who resolves them.",
    ...
    'contact.intro': "Whether this is your first look at the Indian market or you are ready to verify a specific supplier, we will help you take the next step.",
  ...
  pl: {
    ...
    'hero.line1': 'Zanim Ty wsiądziesz w samolot, my już sprawdziliśmy dostawcę.',

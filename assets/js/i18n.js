...
window.VALERIS_I18N = {
  en: {
    ...
    'form.errorName': 'First and last name can only contain letters, spaces, apostrophes and hyphens.',
    'form.errorEmail': 'Please enter a valid email address.',
    'form.errorPhone': 'Please enter a valid phone number (digits, spaces, +, - and parentheses only).',
  ...
  pl: {
    ...
    'form.errorName': 'Imię i nazwisko mogą zawierać tylko litery, spacje, apostrofy i myślniki.',
    'form.errorEmail': 'Podaj prawidłowy adres e-mail.',
    'form.errorPhone': 'Podaj prawidłowy numer telefonu (tylko cyfry, spacje, +, - oraz nawiasy).',
